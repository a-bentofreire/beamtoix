...
(function (Cli) {
    ...
    argOpts['moviePre'] = {
        param: 'array', allowOption: true, desc: "arguments to be passed to ffmpeg before the arguments passed by beamtoix",
    };
    argOpts['moviePost'] = {
        param: 'array', allowOption: true, desc: "arguments to be passed to ffmpeg after the arguments passed by beamtoix",
    };
    argOpts['gifPre'] = {
        param: 'array', allowOption: true, desc: "arguments to be passed to gif generator(convert) before the arguments passed by beamtoix",
    };
    argOpts['gifPost'] = {
        param: 'array', allowOption: true, desc: "arguments to be passed to gif generator(convert) after the arguments passed by beamtoix",
    };
    ...
    function parseArguments() {
        ...
        while (args[argI - 1].search(/beamtoix/) === -1) {
            argI++;
        }
        cmdName = args[argI++];
        if (!cmdName) {
    ...
    function commandCheck() {
        ...
        displayCheck('puppeteer', puppeteer, "\n   BeamToIX requires puppeteer. Install using the following command\nnpm i puppeteer");
    }
    // ------------------------------------------------------------------------
    //                                Command: Create
    // ------------------------------------------------------------------------
    function commandCreate() {
            ...
            switch (fileBase) {
                ...
                case 'index.html':
                    ...
                    if (!noPlugins) {
                        ...
                        var pre_1 = '';
                        var post_1 = '';
                        text.replace(/^(.*)js\/beamtoix-bundle-en\.min\.js(.*)$/m, function (_app, _pre, _post) {
                            pre_1 = _pre;
                            post_1 = _post;
                            return '';
                        });
        ...
        copyTree(LIB_PATH, "".concat(projName, "/beamtoix"), undefined, function (fileBase) {
...
//# sourceMappingURL=beamtoix-cli.js.map